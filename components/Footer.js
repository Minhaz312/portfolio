  ...
  return (
    <>
      ...
      `}</style>
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4 p-3">
              ...
              <p className="d-flex">
                <a
                  href="https://www.facebook.com/mdminhaz.shahidulalam/about"
                  rel="noreferrer"
                  target="_blank"
                >
                  <FontAwesomeIcon
                ...
                <a
                  href="https://www.linkedin.com/in/minhaz-khan-aa0a0119a/"
                  rel="noreferrer"
                  target="_blank"
                >
                  <FontAwesomeIcon
        ...
        <div className="bg-custom-primary footer-desktop p-3 text-center text-white mb-0">
          <p>&copy;copyright 2021. All Right Reserved</p>
        </div>
      </footer>
      <div className="bg-custom-primary footer-mobile w-100 p-1 text-center text-white mb-0">
        <p>&copy;copyright 2021. All Right Reserved</p>
      </div>
    </>
  );
